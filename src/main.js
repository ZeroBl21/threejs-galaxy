...
const generateGalaxy = () => {
	...
	for (let i = 0; i < parameters.count; i++) {
		...
		const randomX =	getRandomValue(parameters.randomnessPower)
		const randomY = getRandomValue(parameters.randomnessPower)
		const randomZ = getRandomValue(parameters.randomnessPower)
